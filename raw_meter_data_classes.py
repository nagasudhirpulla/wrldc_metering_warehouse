...
class RawMeterCumData:
    ...
    def parse(txtLine):
        ...
        data_time = dt.datetime.strptime(strs[4], '%d-%m-%y').date()
        meterHeader = RawMeterCumData(data_time, meter_id, cumm_active_energy_wh,
                                      cumm_reactive_energy_high_wh, cumm_reactive_energy_low_wh)
        return meterHeader
